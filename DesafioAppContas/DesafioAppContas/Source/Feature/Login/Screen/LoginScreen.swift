...
class LoginScreen: UIView {
    ...
    lazy var loginButton: UIButton = {
        ...
        button.backgroundColor = UIColor(red: 22/255, green: 54/255, blue: 94/255, alpha: 1.0)
    ...
    private func configBackGround(){
        self.backgroundColor = UIColor(red: 38/255, green: 63/255, blue: 111/255, alpha: 1.0)
    }
